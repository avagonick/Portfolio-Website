export const Contact = () => {
    return (
        <section id = "contact" className="min-h-screen flex items-center justify-center">
            ...
            <a href="mailto:gonickava@gmail.com"><h4 className="text-xl text-blue-400 hover:text-blue-300 transition-colors my-4"> gonickava@gmail.com </h4></a>
            </div>
            ...
            <a href = "https://www.linkedin.com/in/avagonick/" target="_blank" rel="noopener noreferrer"><h4 className="text-xl text-blue-400 hover:text-blue-300 transition-colors my-4"> https://www.linkedin.com/in/avagonick/ </h4> </a>
            </div>
            </div>
            </div>
