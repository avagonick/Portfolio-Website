...
export const MobileMenu = ({menuOpen, setMenuOpen}) => {
 {/* for the entire mobile menu it says if menu open you can see and click things else you can not it also in that case makes your X button that can be clicked*/}
    return (
